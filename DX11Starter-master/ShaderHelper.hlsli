...
// - You dont necessarily have to keep all the comments; theyre here for your reference
...
float3 DiffuseSpecCalc(Light light, float3 normal, float3 direction, float3 toCamera, float3 albedo, float roughness, float metalness, float3 specColor)
{
